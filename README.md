...
|-----------------------------|-----------------------------------------------------------------------------------------------------------------|-----------|
| AZURE_CLIENT_ID             | The Client ID for the fact Cron Job                                                                             | Yes       |
| CLIENT_SECRET               | The Client Secret for the fact Cron Job                                                                         | Yes       |
| AZURE_TENANT_ID             | The tenant ID for the Azure Active Directory                                                                    | Yes       |
| API_APP_REG_ID              | The FaCT API APP Reg ID                                                                                         | Yes       |
| FACT_DATA_API_URL           | The URL for FaCT data api                                                                                       | Yes       |
